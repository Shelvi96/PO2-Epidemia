...
public class Wierzchołek {
    ...
    private ArrayList<Integer> sąsiedzi;

    public Wierzchołek(int id, double prawdTowarzyski) {
        
        this.id = id;
        this.idTyp = ustawTyp(prawdTowarzyski);
        this.zdrowy = true;
        this.odporny = false;
        this.żywy = true;
    ...
    private int ustawTyp (double prawdTowarzyski) {
