...
public class GrafSpolecznosci {
    ...
    public GrafSpolecznosci(int liczbaKrawędzi, int liczbaAgentów, double prawdTowarzyski, Random rand) {
    ...
    private void stwórzAgentów () {
        ...
        for (int i = 1; i <= liczbaAgentów; ++i) {
            ...
            if (prawd <= prawdTowarzyski){
                ...
                wierzchołki.add(new AgentZwykly(i, rand));
            }
